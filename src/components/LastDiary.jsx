export default function LastDiary({ diaries }) {
  ...
  return (
    <div
      className="my-12 container m-auto flex flex-row bg-[#F6F5F5] drop-shadow-md"
      key="{diaries.id}"
    >
      ...
      <div className="flex flex-wrap flex-col p-12">
        ...
        <button className="bg-[#40B2C9] text-white font-bold px-8 py-2 rounded-tl-lg absolute bottom-0 right-0 ">
          Read more
        </button>
      </div>
    </div>
